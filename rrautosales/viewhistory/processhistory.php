<?php
    ...
    $endp = "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/api/viewhistory/removeFromHistory.php?userID=$userID&vehicleID=$vehicleID";
                    ...
                    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                        <div class="card card-signin my-5 text-center">
                            <div class="card-header">
                                <h3 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">my</i>History</h3>
                            </div>
                            <div class="card-body">
                                <?php 
                            ...
                            <div class="card-footer">
                                <?php
                                    echo "<a class='btn btn-primary btn-sm' href='http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php' role='button'>Back</a>";
                                ?>
                            </div>
                        </div>
                    </div>
