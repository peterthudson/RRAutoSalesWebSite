<?php
    ...
    if(!isset($_SESSION['user_id'])){
        ...
        $countEndp = "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/api/viewhistory/countHistory.php?userid=$userID";
        $numberOfRecords = file_get_contents($countEndp);

        $totalNoPages = ceil($numberOfRecords / $recordsPerPage);
        
        //Get this page's results
        $endp = "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/api/viewhistory/getBasicVehicleInfoFromHistory.php?userID=$userID&page=$pageNo";
        $jsonResult = file_get_contents($endp);
        $myHistory = json_decode($jsonResult, true);
    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php?page=1">View History</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/user/mylistedvehicles.php?page=1">Listed Vehicles</a>
                    </li>
                    <li class="nav-item">
                ...
                <nav aria-label="breadcrumb" class="main-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><h3 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">my</i>History</h3></li>
                    </ol>
                </nav>

                <p><h6>These are all the vehicles you have viewed. The vehicles listed here influence the recommendations we give you.</p></h6>

                <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 g-4">
                    <?php
                        foreach($myHistory as $car) {
                            $vehicleID = $car['ID'];
                            $vechiclePrice = $car['price'];
                            $vehicleYear = $car['year'];
                            $vehicleManufacturer = $car['manufacturer'];
                            $vehicleModel = $car['model'];
                            $vehiclePhoto = $car['thumbnail'];
                                ...
                                <div class='col'>
                                    <div class='card h-100' >
                                        ...
                                        <div class='card-footer text-center'>
                                            ...
                                            <a class='btn btn-danger btn-sm' href='http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/processhistory.php?userID=$userID&vehicleID=$vehicleID' role='button'>Remove</a>
                                        </div>
                                    </div>
                                </div>  
                            ";
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    <li class="<?php if($pageNo==1){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php?page=1" tabindex="-1" aria-disabled="true">First</a>
                    </li>
                    <li class="<?php if($pageNo<=1){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php if($pageNo<=1){echo "#";}else{echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php?page=$prevPage";}?>">Previous</a>
                    </li>
                    <li class="<?php if($pageNo>=$totalNoPages){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php if($pageNo>=$totalNoPages){echo "#";}else{echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php?page=$nextPage";}?>">Next</a>
                    </li>
                    <li class="<?php if($pageNo==$totalNoPages){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/viewhistory/myviewhistory.php?page=$totalNoPages";?>">Last</a>
                    </li>
                </ul>
            </nav>
