<?php
    ...
    if(ISSET($_SESSION['user_id'])) {
        ...
        $adminEndp = "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/api/user/checkSiteAdmin.php?userid=$currentUserID";
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <?php
                                    if(isset($_SESSION['user_id'])) {
                                        if(($ownerUserID == $_SESSION['user_id']) or ($siteAdmin == 1)) {
                                            echo "
                                                <hr>
                                                <div class='row'>
                                                    <div class='d-grid gap-2'>
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <?php
                                        echo "<div>
                                            <iframe id='bingmap' width='380' height='380' frameborder='0' src='https://www.bing.com/maps/embed?h=380&w=380&cp=$lat~$long&lvl=11&typ=d&sty=r&src=SHELL&FORM=MBEDV8' scrolling='no'>
                                            </iframe>
                                            </div>
                                            <p>Region: $region</p>
                                        ";
