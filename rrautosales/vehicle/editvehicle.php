<?php
    ...
    if(!isset($_SESSION["user_id"])){
        ...
        $cylindersID = $details['cylindersid'];
        $fuel = $details['fuel'];
        $FuelID = $details['fuelid'];
                ...
                <div class="row">
                    <div class="col-xs-9 col-sm-11 col-md-11 col-lg-11 col-xl-11 col-xxl-11">
                        <div class="card card-signin my-5">
                            <div class="card-body">
                                <h5 class="card-title text-center"><i class="material-icons text-info mr-2">edit</i>Listing</h5>
                                <?php echo "<form class='form-signin' method='POST' action='processvehicleedit.php?vehicleid=$vehicleID'>"; ?>
                                    <div class="row justify-content-center">  
                                        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-6">
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="manufacturer" style="border-radius:5px" required>
                                                    <?php
                                                        ...
                                                        echo "<option value='$manufacturerID' selected>$manufacturer</option>";
                                            ...
                                            <div class="form-label-group">
                                                <h6>Model</h6>
                                                <?php echo "<input name='model' value='$model' class='form-control' required>"; ?>
                                            </div>
                                            <!-- Condition -->
                                            <div class="form-label-group">
                                                <h6>Condition</h6>
                                                <select class="form-select form-select-sm" name="condition" style="border-radius:5px" required>
                                                    <?php
                                                        ...
                                                        echo "<option value='$conditionID' selected>$condition</option>";
                                            ...
                                            <div class="form-label-group">
                                                <h6>Price</h6>
                                                <?php echo "<input name='price' value='$price' class='form-control' required>"; ?>
                                            </div>
                                            <!-- Year -->
                                            <div class="form-label-group">
                                                <h6>Year</h6>
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="vehType" style="border-radius:5px" required>
                                                    <?php
                                                        ...
                                                        echo "<option value='$vehicletypeID' selected>$vehicletype</option>";
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="driveType" style="border-radius:5px" required>
                                                    <?php
                                                        ...
                                                        echo "<option value='$driveID' selected>$drive</option>";
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="colour" style="border-radius:5px" required>
                                                    <?php
                                                        ...
                                                        echo "<option value='$colourID' selected>$colour</option>";
                                        ...
                                        <div class="col-xs-9 col-sm-9 col-md-6 col-lg-6">
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="cylinders" style="border-radius:5px">
                                                    <?php
                                                        ...
                                                        echo "<option value='$cylindersID' selected>$cylinders</option>";
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="fuelType" style="border-radius:5px">
                                                    <?php
                                                        ...
                                                        echo "<option value='$FuelID' selected>$fuel</option>";
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="title" style="border-radius:5px">
                                                    <?php
                                                        ...
                                                        echo "<option value='$titleID' selected>$title</option>";
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <select class="form-select form-select-sm" name="transmission" style="border-radius:5px">
                                                    <?php
                                                        ...
                                                        echo "<option value='$transmissionID' selected>$transmission</option>";
                                            ...
                                            <div class="form-label-group">
                                                <h6>Latitude</h6>
                                                <?php echo "<input value='$lat' name='lat' class='form-control'>"; ?>
                                            </div>
                                            <div class="form-label-group">
                                                <h6>Longitude</h6>
                                                <?php echo "<input value='$long' name='long' class='form-control'>"; ?>
                                            </div>
                                            <div class="form-label-group">
                                                <h6>Odometer</h6>
                                                <?php echo "<input value='$odometer' name='odometer' class='form-control'>"; ?>
                                            </div>
                                            <div class="form-label-group">
                                                <h6>VIN</h6>
                                                <?php echo "<input value='$vin' name='vin' class='form-control'>"; ?>
                                            </div>
                                        </div>
