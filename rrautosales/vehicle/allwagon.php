...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h2 class='d-flex align-items-center mb-3'><i class='material-icons text-info mr-2'>all</i>Wagons</h2>
            <h6>Browse all the wagons we currently have for sale</h6>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    <li class="<?php if($pageNo==1){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/vehicle/allwagon.php?page=1" tabindex="-1" aria-disabled="true">First</a>
                    </li>
                    <li class="<?php if($pageNo<=1){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php if($pageNo<=1){echo "#";}else{echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/vehicle/allwagon.php?page=$prevPage";}?>">Previous</a>
                    </li>
                    <li class="<?php if($pageNo>=$totalNoPages){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php if($pageNo>=$totalNoPages){echo "#";}else{echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/vehicle/allwagon.php?page=$nextPage";}?>">Next</a>
                    </li>
                    <li class="<?php if($pageNo==$totalNoPages){echo "page-item disabled";}else{echo "page-item";}?>">
                        <a class="page-link" href="<?php echo "http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/vehicle/allwagon.php?page=$totalNoPages";?>">Last</a>
                    </li>
                </ul>
            </nav>
