                ...
                <div class="row">
                    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                        <div class="card card-signin my-5 text-center">
                            <div class="card-body">
                                <h5 class="card-title text-center">Order Complete</h5>
                                <img src="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/img/CardComplete.PNG">
                            </div>
                            <div>
                                <a style="margin-bottom:20px" class="btn btn-primary" href="http://phudson03.lampt.eeecs.qub.ac.uk/rrautosales/" role="button">Home</a>
                            <div>
                        </div>
                    </div>
                </div>
